...
2.  **Base directory:** Se o campo for obrigatório, coloque `./`. Caso contrário, deixe vazio.
3.  **Build command:** `npm run build`
4.  **Publish directory:** `.next`

Clique em **Deploy** e aguarde 3 minutos. O Netlify gerará um link para você!
...
3. Adicione um documento onde o **ID do documento** é o seu **UID de usuário** (que você vê na aba Authentication após o seu primeiro login no site).
